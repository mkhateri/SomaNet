"""Pure-2D post-processing chain (only the functions actually used).

Order: z_postprocess (geometric stitch) -> v4_jump_replace -> z_consistency ->
object_transient_remove -> zspan_filter.  All operate on a (Z,H,W) int label
volume and NEVER use GT. save_nii writes an Amira-ready uint16 volume.
"""
import os
import numpy as np
