#!/bin/bash
# Download the SomaNet (DINOv2) inference checkpoint from Google Drive and place it
...
#   https://drive.google.com/drive/folders/1JtqmRiMHVJKzCVwEzz594E7nYIxqTOvt   (SomaNet_models/dinov2)
...
set -e
FOLDER_URL="https://drive.google.com/drive/folders/1JtqmRiMHVJKzCVwEzz594E7nYIxqTOvt"   # SomaNet_models/dinov2
