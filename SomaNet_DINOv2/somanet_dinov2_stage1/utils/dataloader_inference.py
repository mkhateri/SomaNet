...
class Dataset_cls(Dataset):
    def __init__(self,
        ...
        self.crop = crop_size
        self.apply_inference_augmentation = apply_inference_augmentation()
    ...
    def __getitem__(self, index):
        ...
        if self.task_mode == 'SEG':
            ...
            sample_index = self.apply_inference_augmentation(sample_index)  # Please check augmentation yourself with original implementations
